...
<head>
    ...
    <style> <?php require_once "./public/css/order.css" ?></style>
    <style> <?php require_once "./public/css/product-card.css" ?></style>
    <script src="/t2k/public/js/ajax_updatecart.js"></script>
    <script src="/t2k/public/js/ajax_invoke.js"></script>
    <script src="/t2k/public/js/ajax_updateinfo.js"></script>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="padding: 8px 8px 8px 0;">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item ml-3">
                        <a class="nav-link" id="item" href="#">Về chúng tôi</a>
                    </li>
                </ul>
                <div class="nav-right col-lg-7 col-md-12">
                    <form action="http://localhost/t2k/Product/Search" method="post" class="d-flex nav-right col-7 col-xs-12 ">
                        <input value="" id="keyword" name="keyword" class="form-control"  type="search" placeholder="Tìm kiếm nhanh" aria-label="Search">
                    ...
                    <!-- ====== -->
                    <?php require_once "./mvc/views/blocks/user_login.php"?>
                </div>
        </nav>
        <!-- Content -->
